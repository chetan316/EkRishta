$(document).ready(function () {
    ...
    $("#txtEmail").on("blur", function () {
        var IsEmailIdExists = CheckEmailId();
        if (IsEmailIdExists) {
            $("#dvValidationMessage").html("Email Id Already Registered");
            $("#acNextLoginDetails").attr("disabled", "disabled");
            //$("#acNextLoginDetails").off('click');
        }
        else {
            ClearValidationDiv();
            $("#acNextLoginDetails").removeAttr("disabled");
            //$("#acNextLoginDetails").bind('click');
        }
    });
