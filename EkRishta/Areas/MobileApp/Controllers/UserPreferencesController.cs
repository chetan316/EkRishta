...
namespace EkRishta.Areas.MobileApp.Controllers
{
    public class UserPreferencesController : BaseController
    {
        ...
        //        return PartialView("~/Areas/MobileApp/Views/User/_SetPreferences.cshtml", objBasicDetails);
        //    }
        //    catch (Exception ex)
        //    { }
        //    return View();
        ...
        public ActionResult ManageUserPreferences()
        {
            DataSet dsResponse = new DataSet();
            ...
            try
            {
                ...
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.Parameters.AddWithValue("@UserId", objUserPreference.UserId);
                sqlCmd.Parameters.AddWithValue("@Action", objUserPreference.ActionType);
                sqlCmd.CommandText = "ManageUserPreferences";
                sqlCmd.Connection = connString;
                SqlDataAdapter sda = new SqlDataAdapter(sqlCmd);
                sda.Fill(dsResponse);
            ...
            return View("UserPreferences", objPreference);
        }
        ...
        public ActionResult ManageUserPreferences(UserPreference objUserPreference)
        {
            ...
            catch (Exception ex)
            {
                ...
                return PartialView("~/Areas/MobileApp/Views/UserPreferences/_SetPreference.cshtml", objPreference);
        }
    }
}